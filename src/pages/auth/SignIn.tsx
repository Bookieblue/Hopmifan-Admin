...
import { useLogin } from '@/hooks/services/auth/hook';
...
export default function SignIn() {
  ...
  const { mutate, isSuccess, isPending, isError, data } = useLogin();
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      console.log('running success', token, email);
      navigate('/home');
    }
  ...
  }, [isSuccess, isError, navigate, toast]);
