...
const DEFAULT_AUTHOR_BIO =
  "Whether you're looking for in-depth Bible studies or encouragement for life's challenges, you'll find the perfect resource here. Strengthen your prayer life with our dedicated prayer books and guides. These publications provide practical steps for effective prayer, intercession, and seeking God's will.";
const DEFAULT_AUTHOR_IMAGE =
  '/lovable-uploads/a7e3d08f-9128-4e8b-a73b-9624c392a130.png';
...
export function BookForm({
  ...
  const [authorBio, setAuthorBio] = useState(
    initialData?.authorBio ?? DEFAULT_AUTHOR_BIO
  );
  ...
  const [bookImagePreview, setBookImagePreview] = useState<string>(
    initialData?.bookImage ?? ''
  );
  const [authorImagePreview, setAuthorImagePreview] = useState<string>(
    initialData?.authorImage ?? DEFAULT_AUTHOR_IMAGE
  );
